package com.major_pro.teachAbit;
...
import com.major_pro.teachAbit.Adapter.MessageAdapter;
import com.major_pro.teachAbit.Fragments.APIService;
import com.major_pro.teachAbit.Model.Chat;
import com.major_pro.teachAbit.Model.User;
import com.major_pro.teachAbit.Notifications.Client;
import com.major_pro.teachAbit.Notifications.Data;
import com.major_pro.teachAbit.Notifications.MyResponse;
import com.major_pro.teachAbit.Notifications.Token;
...
//                msg = en.encryptMessage(msg.toCharArray());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                readMesagges(fuser.getUid(), userid, user.getImageURL(), en);
            }
...
//        Toast.makeText(this , message, Toast.LENGTH_SHORT).show();
    ...
    private void readMesagges(final String myid, final String userid, final String imageurl, Encryption en){
        mchat = new ArrayList<>();
        // chat is a userdefined class
        // chat contains all the attributes of hashmap that were used while sending message
        // Encrypt chat
        // recieve chat and modify getMessage()
        // Decrypt chat
        reference = FirebaseDatabase.getInstance().getReference("Chats");
        reference.addValueEventListener(new ValueEventListener() {
            @RequiresApi(api = Build.VERSION_CODES.O)
